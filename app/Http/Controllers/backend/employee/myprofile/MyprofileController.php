...
namespace App\Http\Controllers\backend\employee\myprofile;
...
class MyprofileController extends Controller
{
   ...
   public function myprofile(Request $request){
       if ($request->isMethod('post')) {
           ...
           if($result){
               ...
               $return['redirect'] = route('employee-my-profile');
           }else{
               $return['status'] = 'error';
       ...
       return view('backend.employee.pages.dashboard.profile', $data);
   }
   public function changepassword(Request $request){
       ...
       return view('backend.employee.pages.dashboard.changepassword', $data);
   }
}

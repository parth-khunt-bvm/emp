																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<th class="column" width="170" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																			<table width="100%" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					<td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{ asset('public/frontend/assets/images/images/logo-light.svg') }}" width="104" height="20" border="0" alt="" /></td>
																				</tr>
																			</table>
																		</th>
																				...
																				<tr>
																					<td align="right">
																						<table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
																							<tr>
																								<td class="img" width="55" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{ asset('public/frontend/assets/images/images/ico_facebook.jpg') }}" width="33" height="33" border="0" alt="" /></td>
																								<td class="img" width="55" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{ asset('public/frontend/assets/images/images/ico_twitter.jpg') }}" width="33" height="33" border="0" alt="" /></td>
																								<td class="img" width="55" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{ asset('public/frontend/assets/images/images/ico_instagram.jpg') }}" width="33" height="33" border="0" alt="" /></td>
																								<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{ asset('public/frontend/assets/images/images/ico_linkedin.jpg') }}" width="33" height="33" border="0" alt="" /></td>
																							</tr>
																						</table>
																					</td>
																				</tr>

    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                <form class="form" id="add-testimonials-form" method="POST">@csrf

                    <div class="card-body">
                        <div class="form-group ">
                            <label class="col-form-label ">Name
                            <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="name" name="name"  placeholder="Please enter testimonials name"/>
                        </div>

                        <div class="form-group ">
                            <label class="col-form-label ">Description (Max  : 80 Characters)
                            <span class="text-danger">*</span></label>
                            <textarea class="form-control" id="description" name="description" placeholder="Please enter testimonials description"></textarea>
                        </div>

...
@endphp
<!-- begin::User Panel-->
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10" style="height: 375px !important">
    <!--begin::Header-->
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url({{ asset('public/upload/userprofile/'.$data['userimage']) }})"></div>
                <i class="symbol-badge bg-success"></i>
            </div>
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ $data['firstname'] ." ". $data['lastname']}}</a>
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <!--begin::Item-->
            <a href="{{ route('admin-my-profile') }}" class="navi-item">
                <div class="navi-link">

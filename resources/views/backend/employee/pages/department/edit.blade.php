                ...
                <form class="form" id="add-department-form" method="POST">@csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group ">
                            <label class="col-form-label ">Department (Ex : Web Design , App Development)
                            <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="department" name="department" placeholder="Please enter department" value="{{  $details[0]->department }}" />
                        </div>
                    </div>

    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
       ...
       <div class="topbar">
          ...
          <div class="topbar-item">
             ...
             <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ $data['firstname'] ." ". $data['lastname']}}</span>
                <span class="symbol symbol-lg-35 symbol-25 symbol-light-warning">
                <span class="symbol-label font-size-h5 font-weight-bold">{{ substr($data['firstname'],0,1) }}</span>
                </span>
             </div>
          </div>
          <!--end::User-->

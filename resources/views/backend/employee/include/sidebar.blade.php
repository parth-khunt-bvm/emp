...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                <li class="menu-item {{ ( $currentRoute == 'employee-dashboard'  ? 'menu-item-active' : '' )  }}"
                    aria-haspopup="true">
                ...
                <li class="menu-item {{ ( $currentRoute == 'employee-department'  || $currentRoute == 'employee-department-add' || $currentRoute == 'employee-department-edit'  ? 'menu-item-active' : '' )  }}"
                    aria-haspopup="true">
                ...
                <li class="menu-item {{ ( $currentRoute == 'employee-designation'  || $currentRoute == 'employee-designation-add' || $currentRoute == 'employee-designation-edit'  ? 'menu-item-active' : '' )  }}"
                    aria-haspopup="true">
                ...
                <li class="menu-item {{ (  $currentRoute == "employee-salaryslip" || $currentRoute == 'employee-salaryslip-add'  || $currentRoute == 'employee-salaryslip-view'   ? 'menu-item-active' : '' )  }}"
                    aria-haspopup="true">
                    <a href="{{  route('employee-salaryslip') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Design/Layers.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="menu-text">Create Salary Slip</span>
                    </a>
                </li>
